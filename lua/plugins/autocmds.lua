  ...
  opts = {
    commands = {
      AstroVersion = {
        ...
        desc = "Check Nvim Version",
      },
      AstroReload = { function() require("astrocore").reload() end, desc = "Reload Nvim (Experimental)" },
      ...
      file_user_events = {
        {
          ...
          desc = "Nvim user events for file detection (AstroFile and AstroGitFile)",
          callback = function(args)
