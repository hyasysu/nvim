return {
    ...
    config = function(_, opts)
        ...
        wk.add({
            ...
            { "<leader>c",         group = "CodeCompanion/CodeLens", icon = get_icon("ui", "AI", 1) },
            { "<leader>d",         group = "Debugger",               icon = get_icon("dap", "Debugger", 1) },
            { "<leader>e",         group = "Neotree",                icon = get_icon("ui", "NeoTree", 1) },
            { "<leader>F",         group = "Telescope",              icon = get_icon("ui", "Search", 1) },
            ...
            { "<leader>t",         group = "Terminal/TS/Conform",    icon = get_icon("ui", "Terminal", 1) },
            ...
            { "<leader><leader>",  group = "Second Menu",            icon = get_icon("ui", "Menu", 1) },
            { "<leader><leader>m", group = "BookMark",               icon = get_icon("ui", "BookMark", 1) },
        }, {
            mode = { "n", "v", "i", "t" },
        })
    end,
